...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <!-- Total Amount (Monthly) Card Example -->
                ...
                <div class="card border-left-info shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Sale Orders
                                </div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $sale_order }}</div>
                            </div>
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Cancel Orders
                                </div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $cancel_order }}</div>
                            </div>
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">All Orders
                                </div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $all_order }}</div>
                            </div>
                            <div class="col-auto">
